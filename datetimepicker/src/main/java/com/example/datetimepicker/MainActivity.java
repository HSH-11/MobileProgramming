...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button selectTimeButton = findViewById(R.id.selected_time_button);
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
            ...
            @Override
            public void onDateSet(DatePicker view, int selectedYear, int selectedMonth, int selectedDayOdMonth
            ) {
                String selectedDate = selectedYear + "-" + (selectedMonth + 1) + "-" + selectedDayOdMonth;
